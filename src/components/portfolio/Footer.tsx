const Footer = () => {
  ...
  const socials = [
    ...
    {
      label: "LinkedIn",
      href: "https://www.linkedin.com/in/saurabh-magdum-940223221",
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <footer className="section-dark border-t border-white/10 py-16 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          {/* Brand */}
          <div>
            <div className="text-white font-black text-2xl mb-4">
              SM<sup className="text-xs font-normal">®</sup>
            </div>
            <p className="text-white/50 text-sm leading-relaxed max-w-xs">
              ML Engineer & AI Agent Architect building intelligent systems that scale. No fluff, just results.
            </p>
          </div>

          {/* Navigation */}
          <div>
            <p className="text-white/40 text-xs font-bold uppercase tracking-widest mb-4">Navigation</p>
          ...
          {/* Contact */}
          <div>
            <p className="text-white/40 text-xs font-bold uppercase tracking-widest mb-4">Get in Touch</p>
            <a
              href="mailto:saurabh.magdum@gmail.com"
              className="text-white/60 hover:text-white text-sm transition-colors block mb-4"
            >
              saurabh.magdum@gmail.com
            </a>
